...
```txt
app/frontend/src/views/AdvancedSearch/AdvancedSearchBuilderView.ts
app/frontend/src/views/AdvancedSearch/AdvancedSearchSelection.ts
app/frontend/src/views/AdvancedSearch/AdvancedSearchToolbar.ts
app/frontend/src/views/AdvancedSearch/AdvancedSearchConditionRestorer.ts
app/frontend/src/views/Condition/
app/frontend/src/views/Condition/queryBuilders/
...
```txt
app/frontend/src/views/SearchField/
app/frontend/src/views/SideBar.ts
app/frontend/src/views/PanelView/
app/frontend/src/store/searchManager.ts
...
```txt
app/frontend/src/api/fetchData.ts
app/frontend/src/views/DownloadButton.ts
