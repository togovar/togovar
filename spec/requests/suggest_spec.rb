...
RSpec.describe 'Suggests', type: :request do
  describe 'GET /index' do
    ...
    it 'suggests Breast-ovarian cancer, familial, susceptibility to, 1' do
      ...
      json = JSON.parse(response.body)
      expect(json.keys).to match_array(%w[gene disease])
      expect(json['disease']).to include('term' => 'Breast-ovarian cancer, familial, susceptibility to, 1')
    end
  end
end
